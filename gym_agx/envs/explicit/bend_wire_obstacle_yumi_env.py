...
SCENE_PATH = os.path.join(PACKAGE_DIRECTORY, 'assets', 'bend_wire_obstacle_yumi.agx')
GOAL_SCENE_PATH = os.path.join(PACKAGE_DIRECTORY, 'assets', 'bend_wire_obstacle_yumi_goal.agx')
...
class BendWireObstacleYuMiEnv(dlo_env.DloEnv):
    ...
    def __init__(self, n_substeps, observation_config=None, joints=None, reward_type=None, reward_config=None,
        ...
        super(BendWireObstacleYuMiEnv, self).__init__(args=args,
                                          scene_path=scene_path,
    ...
    def reset(self):
        logger.info("reset")
        super(BendWireObstacleYuMiEnv, self).reset()
        did_reset_sim = False
